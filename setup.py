...
# requirements = [
# "alabaster==0.7.9", "argh==0.26.2", "arrow==0.10.0", "Babel==2.3.4", "binaryornot==0.4.0", "cffi==1.9.1",\
# "chardet==2.3.0", "click==6.6", "cycler==0.10.0", "docutils==0.12",\
# "enum34==1.1.6", "future==0.16.0", "idna==2.1", "imagesize==0.7.1", "ipaddress==1.0.17", "Jinja2==2.8", "jinja2-time==0.2.0",\
...
# "python-dateutil==2.6.0", "pytz==2016.7", "six==1.10.0", "snowballstemmer==1.2.1", "Sphinx==1.4.8", "Theano==0.8.2",\
# "virtualenv==15.1.0", "whichcraft==0.4.0"
# ]

requirements = [
"Lasagne==0.1", "matplotlib==1.5.3", "numpy==1.11.2", "pandas==0.19.1", "py==1.4.31", "python-dateutil==2.6.0", "Theano==0.8.2"
]
